...
export default function MeScreen() {
    ...
    useCallback(() => {
      ...
      const fetchCounts = async () => {
        try {
          ...
          const savedFoundCol = collection(
            db,
            "users",
            user.uid,
            "saved_found",
  ...
  const handleMenuPress = (item: string) => {
    ...
    else if (item === "รายการรับของของฉัน")
      router.push("/claimed-posts-screen");
  };
      ...
      <SafeAreaView edges={["top"]} style={{ flex: 1 }}>
        ...
        <View style={styles.header}>
          ...
          <View style={styles.statsRow}>
            <Pressable
              ...
              onPress={() => router.push("/my-posts-screen")}
            >
              {postCount === null ? (
        ...
        <View style={styles.content}>
          ...
          <Pressable
            ...
            onPress={() => {
              Linking.openURL("https://line.me/R/ti/p/@750dzczn");
            }}
          >
            <Ionicons
            ...
            />
            <Text style={styles.contactText}>ติดต่อแอดมิน (LINE)</Text>
          </Pressable>
